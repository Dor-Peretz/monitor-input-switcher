"""Load and save monitor switcher configuration (macOS build).

The config format is identical to the Windows build so a config.json can be
shared between the two. Only the default hotkeys differ (macOS conventions).
"""
...
# Standard DDC/CI VCP 0x60 input source values (same codes m1ddc/ddcctl use).
